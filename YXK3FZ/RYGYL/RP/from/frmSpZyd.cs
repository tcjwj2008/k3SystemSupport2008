...
{
    public partial class frmSpZyd : Form
    {
        ...
        private void frmSpZyd_Load(object sender, EventArgs e)
        {
            commUse.CortrolButtonEnabled(button1, this);
            commUse.CortrolButtonEnabled(button2, this);
            commUse.CortrolButtonEnabled(button4, this);
            commUse.CortrolButtonEnabled(button5, this);
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
           ...
           // this.toolStripStatusLabel1.Text = " 正在读取表格数据......";
            ...
            try
            {
                ds2 = db.GetProcDataSet("sp_sel_spmdsyb", inputParameters);
