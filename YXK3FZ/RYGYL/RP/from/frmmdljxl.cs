...
{
    public partial class frmmdljxl : Form
    {
        ...
        private void frmmdljxl_Load(object sender, EventArgs e)
        {
            this.toolStripLabel1.Text = "部门：" + fdepnum;
            this.toolStripLabel2.Text = "开始日期：" + fdate;
            this.toolStripLabel2.Text = "结束日期：" + fdate;
