...
namespace YXK3FZ.ComClass
{
    ...
    public class PropertyClass
    {
        ...
        public static string con_rymd = "Data Source=188.188.1.190;Initial Catalog=Waste;User ID=sa;Password=123456";
                ...
                public static string con_yz = "Data Source=188.188.1.8;Initial Catalog=AIS_YXDZP2018;User ID=sa;Password=Asd123;Connect Timeout=0";
                public static string con_yzyinxiang = "Data Source=188.188.1.8;Initial Catalog=yinxiang;User ID=sa;Password=Asd123;Connect Timeout=0";	
